<template>
    <section id="about" class="hero bg-gray-100 py-16">
      <div class="about-container mx-auto max-w-7xl flex flex-wrap justify-center items-start">
        ...
        <div class="about-content w-full md:w-1/2 mt-10 md:mt-0">
          ...
          <div class="about-text mb-8">
            <p class="text-base leading-6">Passionné par la cybersécurité, je bénéficie d'expériences en sécurité offensive et
participe à différents CTF. Je possède une bonne connaissance de la sécurité des
SI et des enjeux cyber actuels. Rigoureux et méthodique, j'aime chercher et
vérifier les informations via l'OSINT.
Doté d'une grande capacité d'organisation et d'adaptation, je sais m'intégrer
dans de nouveaux contextes de travail grace à un véritable esprit d'équipe.</p>
          </div>
